  ...
  <!--Main Section-->
    <div class='row'>
      <div class='col-lg-12'>
          ...
          <h1>Fragments d'écriture</h1>

          <?php
          $pages = get_posts( array( 'sort_order' => 'post_date', 'sort_column' => 'post_date' ) );
          echo '<div class="row">';
             ...
             $post = get_post($page->ID);          
              ...
              if ($hideHomepage[0] == "1"){}
                        ...
                        //  $cardCtnt = '<img class="card-img" src="' . $featured_img_url . '"/>';
                          ...
                          //$cardCtnt .= '<div class="card-img-overlay"><a href="' . get_page_link( $page->ID ) . '" class="card-link">' . $page->post_title . '</a></div>';
